...
#define AI_NETWORK_MODEL_SIGNATURE     "0xebeda03354ef1de5cc92348599d07e54"
...
#define AI_TOOLS_DATE_TIME   "2026-03-18T12:34:28+0100"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  2, 0x0,
  AI_SHAPE_INIT(4, 6, 32, 1, 1), AI_STRIDE_INIT(4, 4, 24, 768, 768),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 3348, 1, 1),
    3348, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 192, 1, 1),
    192, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_IN_NUM, &serving_default_keras_tensor_40_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_OUT_NUM, &nl_3_output),
  &gemm_0_layer, 0xbbb79a2b, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    serving_default_keras_tensor_40_output_array.data = AI_PTR(g_network_activations_map[0] + 40);
    serving_default_keras_tensor_40_output_array.data_start = AI_PTR(g_network_activations_map[0] + 40);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    gemm_1_weights_array.data = AI_PTR(g_network_weights_map[0] + 896);
    gemm_1_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 896);
    gemm_1_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_1_bias_array.data = AI_PTR(g_network_weights_map[0] + 2944);
    gemm_1_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 2944);
    gemm_2_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_weights_array.data = AI_PTR(g_network_weights_map[0] + 3008);
    gemm_2_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 3008);
    gemm_2_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_bias_array.data = AI_PTR(g_network_weights_map[0] + 3328);
    gemm_2_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 3328);
    return true;
  }
